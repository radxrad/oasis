...
// watch for a URL change
    ...
    var receiveMessage = function receiveMessage(e){
        if (e.origin !== "https://staging.outbreak.flashpub.io/" || e.origin !== "https://outbreak.flashpub.io/" )
            return;
        ...
        // Handle the message
        switch (e.data) {
            case 'iframe_change': console.log('iframe_change'); break;
        }
    };
    ...
    <Grid
        container>
            <Iframe url="https://staging.outbreak.flashpub.io/publish/covid-19-diagnostics-assessment"
            width="450px"
            height="900px"
            id="flashPubId"
